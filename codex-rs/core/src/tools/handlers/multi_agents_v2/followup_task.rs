...
use super::*;
use crate::tools::handlers::external_agents_spec::create_external_followup_task_tool;
...
impl ToolExecutor<ToolInvocation> for Handler {
    ...
    fn spec(&self) -> ToolSpec {
        match self.surface {
            AgentTransport::Collaboration => create_followup_task_tool(),
            AgentTransport::ExternalAgents => create_external_followup_task_tool(),
        }
    }
